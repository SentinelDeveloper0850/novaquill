...
CREATE TABLE "public"."User" (
    ...
    "subscription" "public"."SubscriptionStatus" NOT NULL DEFAULT 'FREE',
    "subscriptionPlan" "public"."SubscriptionPlan",
    "lastPaymentAt" TIMESTAMP(3),
    "payfastLastPaymentId" TEXT,
    "docsUsedThisMonth" INTEGER NOT NULL DEFAULT 0,
    "usageYearMonth" INTEGER,
...
-- CreateTable
CREATE TABLE "public"."EventCounter" (
    "name" TEXT NOT NULL,
    "count" INTEGER NOT NULL DEFAULT 0,

    CONSTRAINT "EventCounter_pkey" PRIMARY KEY ("name")
);

-- CreateTable
CREATE TABLE "public"."PayfastEvent" (
    "id" TEXT NOT NULL,
    "pfPaymentId" TEXT NOT NULL,
    "payload" JSONB NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "PayfastEvent_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "PayfastEvent_pfPaymentId_key" ON "public"."PayfastEvent"("pfPaymentId");
