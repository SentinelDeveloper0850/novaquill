    ...
    <div className="min-h-screen bg-background text-foreground">
      <main className="max-w-5xl mx-auto px-6 py-20 grid gap-8">
        ...
        <p className="text-lg text-foreground/80 max-w-2xl">
          Minimalist, global e‑signing with ShapeAssist real‑time correction. No emails. No watermarks.
        </p>
        ...
        <div className="grid sm:grid-cols-3 gap-6 pt-10">
          ...
          <div className="rounded-lg border border-foreground/10 p-5 bg-background/60">
            ...
            <div className="text-foreground/70 text-sm">Get a clean, legally‑compliant PDF. No branding.</div>
          </div>
        </div>
        ...
        <section className="pt-6 grid gap-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <div className="rounded-lg border border-foreground/10 p-5">
              <div className="font-medium mb-1">Clean, compliant PDFs</div>
              <div className="text-foreground/70 text-sm">Flattened output, no watermarks, designed for GDPR/eIDAS compliance.</div>
            </div>
            <div className="rounded-lg border border-foreground/10 p-5">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="rounded-lg border border-foreground/10 p-5">
              ...
              <div className="text-foreground/70 text-sm">Free: 3 docs/month. Pro: unlimited cloud storage and signing.</div>
            </div>
            <div className="rounded-lg border border-foreground/10 p-5">
              <div className="font-medium mb-1">Private by design</div>
              <div className="text-foreground/70 text-sm">TLS in transit, AES‑256 at rest. You control and can delete your files.</div>
            </div>
            <div className="rounded-lg border border-foreground/10 p-5">
        ...
        <section className="pt-6 grid gap-4">
          ...
          <details className="rounded-lg border border-foreground/10 p-4">
            ...
            <div className="text-foreground/70 text-sm mt-2">No. Anonymous users can upload, sign and download. Accounts unlock cloud storage and usage tracking.</div>
          </details>
          <details className="rounded-lg border border-foreground/10 p-4">
          ...
          <details className="rounded-lg border border-foreground/10 p-4">
            ...
            <div className="text-foreground/70 text-sm mt-2">Yes. TLS in transit, AES‑256 at rest. Only you can access your documents, and you can permanently delete them.</div>
          </details>
        </section>
      </main>
    </div>
